...
<div class="px-52 py-20 mx-auto">
<form action="/projects/tasks" method="post">
    @csrf
  <div class="relative z-0 w-full mb-6 group">
      <input type="text" name="body" id="body" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="{{$project->title?? ''}}" required />
      <input type="number" hidden name="id" value="{{$project_id}}">
